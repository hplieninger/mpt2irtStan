...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(156, 154, "end", "model_stan_boeck_shift");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  beta(static_cast<Eigen::VectorXd::Index>(J),static_cast<Eigen::VectorXd::Index>(3));
            ...
            for (int j = 1; j <= J; ++j) {
                ...
                stan::model::assign(beta, 
                            stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_uni(3), stan::model::nil_index_list())), 
                            (get_base1(mu_beta,(2 + get_base1(traitItem,j,"traitItem",1)),"mu_beta",1) + get_base1(beta_raw,j,3,"beta_raw",1)), 
                            "assigning variable beta");
            }
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int j = 1; j <= J; ++j) {
                    ...
                    stan::model::assign(trait, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list())), 
                                Phi_approx((get_base1(theta,i,3,"theta",1) + (pow(-(1),get_base1(revItem,j,"revItem",1)) * (get_base1(theta,i,(3 + get_base1(traitItem,j,"traitItem",1)),"theta",1) - get_base1(beta,j,3,"beta",1))))), 
                    ...
                    stan::model::assign(p_cat, 
                                ...
                                (((1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2)) * (1 - get_base1(get_base1(trait,i,"trait",1),j,"trait",2))) * get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2)), 
                    ...
                    stan::model::assign(p_cat, 
                                ...
                                (((1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2)) * (1 - get_base1(get_base1(trait,i,"trait",1),j,"trait",2))) * (1 - get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2))), 
                                "assigning variable p_cat");
                    ...
                    stan::model::assign(p_cat, 
                                ...
                                get_base1(get_base1(middle,i,"middle",1),j,"middle",2), 
                                "assigning variable p_cat");
                    ...
                    stan::model::assign(p_cat, 
                                ...
                                (((1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2)) * get_base1(get_base1(trait,i,"trait",1),j,"trait",2)) * (1 - get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2))), 
                                "assigning variable p_cat");
                    ...
                    stan::model::assign(p_cat, 
                                ...
                                (((1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2)) * get_base1(get_base1(trait,i,"trait",1),j,"trait",2)) * get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2)), 
                                "assigning variable p_cat");
                }
            }
...
typedef model_stan_boeck_shift_namespace::model_stan_boeck_shift stan_model;
