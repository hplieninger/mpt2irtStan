...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(244, 242, "end", "model_stan_boeck_ext_HH");
    return reader;
}
                ...
                for (int j = 1; j <= J; ++j) {
                    ...
                    if (as_bool(logical_eq(get_base1(traitItem,j,"traitItem",1),1))) {
                        ...
                        stan::model::assign(acquies, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list())), 
                                    Phi_approx((get_base1(theta,i,S,"theta",1) - get_base1(beta,j,3,"beta",1))), 
...
typedef model_stan_boeck_ext_HH_namespace::model_stan_boeck_ext_HH stan_model;
