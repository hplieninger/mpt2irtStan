...
namespace model_stan_boeck_ext2_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_stan_boeck_ext2");
    reader.add_event(210, 208, "end", "model_stan_boeck_ext2");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_stan_boeck_ext2 : public prob_grad {
private:
    int N;
    int J;
    vector<vector<int> > X;
    ...
    matrix_d V;
public:
    model_stan_boeck_ext2(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_stan_boeck_ext2_namespace::model_stan_boeck_ext2";
        ...
        validate_non_negative_index("beta_raw", "J", J);
            validate_non_negative_index("beta_raw", "5", 5);
            num_params_r__ += J * 5;
            current_statement_begin__ = 42;
            validate_non_negative_index("mu_beta", "(S + 1)", (S + 1));
            num_params_r__ += (S + 1);
            current_statement_begin__ = 43;
            validate_non_negative_index("sigma2_beta_raw", "(S + 2)", (S + 2));
            num_params_r__ += (S + 2);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("beta_raw", "J", J);
        validate_non_negative_index("beta_raw", "5", 5);
        context__.validate_dims("initialization", "beta_raw", "matrix_d", context__.to_vec(J,5));
        matrix_d beta_raw(static_cast<Eigen::VectorXd::Index>(J),static_cast<Eigen::VectorXd::Index>(5));
        ...
        pos__ = 0U;
        validate_non_negative_index("sigma2_beta_raw", "(S + 2)", (S + 2));
        context__.validate_dims("initialization", "sigma2_beta_raw", "vector_d", context__.to_vec((S + 2)));
        vector_d sigma2_beta_raw(static_cast<Eigen::VectorXd::Index>((S + 2)));
        for (int j1__ = 0U; j1__ < (S + 2); ++j1__)
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                beta_raw = in__.matrix_lub_constrain(-(5),5,J,5,lp__);
            else
                beta_raw = in__.matrix_lub_constrain(-(5),5,J,5);
            ...
            if (jacobian__)
                sigma2_beta_raw = in__.vector_lb_constrain(0,(S + 2),lp__);
            else
                sigma2_beta_raw = in__.vector_lb_constrain(0,(S + 2));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  beta(static_cast<Eigen::VectorXd::Index>(J),static_cast<Eigen::VectorXd::Index>(5));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  sigma_beta_raw(static_cast<Eigen::VectorXd::Index>((S + 1)));
            ...
            validate_non_negative_index("extreme_a", "J", J);
            vector<vector<local_scalar_t__> > extreme_a(N, (vector<local_scalar_t__>(J)));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int j = 1; j <= J; ++j) {
                    ...
                    stan::model::assign(extreme_a, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list())), 
                                Phi_approx((get_base1(theta,i,2,"theta",1) - get_base1(beta,j,5,"beta",1))), 
                    ...
                    stan::model::assign(p_cat, 
                                ...
                                (((((1 - get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2)) * (1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2))) * get_base1(get_base1(trait,i,"trait",1),j,"trait",2)) * (1 - get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2))) + (get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2) * (1 - get_base1(get_base1(extreme_a,i,"extreme_a",1),j,"extreme_a",2)))), 
                                "assigning variable p_cat");
                    ...
                    stan::model::assign(p_cat, 
                                ...
                                (((((1 - get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2)) * (1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2))) * get_base1(get_base1(trait,i,"trait",1),j,"trait",2)) * get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2)) + (get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2) * get_base1(get_base1(extreme_a,i,"extreme_a",1),j,"extreme_a",2))), 
                                "assigning variable p_cat");
                }
            }
            ...
            for (int i0__ = 0; i0__ < N; ++i0__) {
                for (int i1__ = 0; i1__ < J; ++i1__) {
                    if (stan::math::is_uninitialized(extreme_a[i0__][i1__])) {
                        std::stringstream msg__;
                        msg__ << "Undefined transformed parameter: extreme_a" << '[' << i0__ << ']' << '[' << i1__ << ']';
                        throw std::runtime_error(msg__.str());
                    }
                }
            }
            ...
            for (int k0__ = 0; k0__ < N; ++k0__) {
                for (int k1__ = 0; k1__ < J; ++k1__) {
                    check_greater_or_equal(function__,"extreme_a[k0__][k1__]",extreme_a[k0__][k1__],0);
                    check_less_or_equal(function__,"extreme_a[k0__][k1__]",extreme_a[k0__][k1__],1);
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_stan_boeck_ext2_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        matrix_d beta_raw = in__.matrix_lub_constrain(-(5),5,J,5);
        vector_d mu_beta = in__.vector_lub_constrain(-(5),5,(S + 1));
        vector_d sigma2_beta_raw = in__.vector_lb_constrain(0,(S + 2));
            ...
            for (int k_0__ = 0; k_0__ < (S + 2); ++k_0__) {
        ...
        try {
            ...
            for (int k_1__ = 0; k_1__ < J; ++k_1__) {
                for (int k_0__ = 0; k_0__ < N; ++k_0__) {
                vars__.push_back(extreme_a[k_0__][k_1__]);
                }
            }
            }
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  sigma_beta(static_cast<Eigen::VectorXd::Index>((S + 1)));
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= (S + 2); ++k_0__) {
            param_name_stream__.str(std::string());
        ...
        if (include_tparams__) {
            ...
            for (int k_1__ = 1; k_1__ <= J; ++k_1__) {
                for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "extreme_a" << '.' << k_0__ << '.' << k_1__;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
        }
...
typedef model_stan_boeck_ext2_namespace::model_stan_boeck_ext2 stan_model;
