...
#include "stanExports_stan_boeck_ext2.h"

RCPP_MODULE(stan_fit4stan_boeck_ext2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_stan_boeck_ext2")
