...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(180, 178, "end", "model_stan_boeck_2012");
    return reader;
}
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int j = 1; j <= J; ++j) {
                    ...
                    stan::model::assign(trait, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list())), 
                                Phi_approx((pow(-(1),get_base1(revItem,j,"revItem",1)) * (get_base1(theta,i,(2 + get_base1(traitItem,j,"traitItem",1)),"theta",1) - get_base1(beta,j,3,"beta",1)))), 
...
typedef model_stan_boeck_2012_namespace::model_stan_boeck_2012 stan_model;
